    ...
    return SliderDrawerWidget(
      ...
      body: Scaffold(
          ...
          body: GetBuilder<ProfileController>(builder: (profileControl) {
            if (profileControl.userData != null) {
              print(Get.find<ProfileController>().patientData!.bpProblem);
              _firstnameController.text =
                  profileControl.userData!.firstName.toString();
              _lastNameController.text =
                  profileControl.userData!.lastName.toString();
              _dateController.text = profileControl.patientData!.dob.toString();
            }
            return profileControl.userDataLoading
